...
function buildScrollMap () {
  let i; let offset; let nonEmptyList; let pos; let a; let b; let lineHeightMap; let linesCount
  let acc; let sourceLikeDiv; const textarea = $('.source')
  let _scrollMap
  ...
  $('.line').each(function (n, el) {
    const $el = $(el); let t = $el.data('line')
    if (t === '') { return }
    t = lineHeightMap[t]
